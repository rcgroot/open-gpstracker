        ...
        synchronized (mStartLock) {
            if (mBound) {
                try {
                    ...
                    Timber.e("Could not send datasource to GPSLoggerService.", e);
                }
            } else {
        ...
        synchronized (mStartLock) {
            if (mBound) {
                try {
                    ...
                    Timber.e("Could not send media to GPSLoggerService.", e);
                }
            } else {
                Timber.e("No GPSLoggerRemote service connected to this manager");
            }
    ...
    public void shutdown(Context context) {
        synchronized (mStartLock) {
            try {
                ...
                Timber.w("Failed to unbind a service, prehaps the service disapearded?", e);
            }
        }
    }
}