...
public class GetBreadcrumbsActivitiesTask extends AsyncTask<Void, Void, Void>
{
   ...
   private BreadcrumbsAdapter mContext;
   private OAuthConsumer mConsumer;
   private DefaultHttpClient mHttpclient;
   private HashMap<String, Integer> activityMappings = new HashMap<String, Integer>();
   private Vector<String> activities = new Vector<String>();
   ...
   protected Void doInBackground(Void... params)
   {
      try
      {
         ...
         while (eventType != XmlPullParser.END_DOCUMENT)
         {
            ...
            {
               if( "activity".equals(xpp.getName()) && name != null && id != null )
               {
                  activityMappings.put(name, id);
                  activities.add(name);
               }
               tagName = null;
            }
   ...
   protected void onPostExecute(Void result)
   {
      ...
      mContext.setActivities( activities, activityMappings );
   }
